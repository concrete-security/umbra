...
from umbra_console.sessions import issue_token_pair
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Bootstrap the first Umbra Console admin")
...
async def run() -> int:
    if os.environ.get("UMBRA_ALLOW_BOOTSTRAP") != "true":
        print("[usage] set UMBRA_ALLOW_BOOTSTRAP=true to run bootstrap", file=sys.stderr)
        return 2
