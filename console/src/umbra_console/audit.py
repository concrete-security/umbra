...
AUDIT_ACTIONS = (
    "LOCAL_WORKSPACE_STARTED",
    "LOCAL_WORKSPACE_STOPPED",
    "ENTITY_CREATED",
    "ENTITY_UPDATED",
    "USER_REGISTERED",
    "USER_DEACTIVATED",
    ...
    "SECURITY_CVM_STOPPED",
    "SECURITY_CVM_FAILED",
    "SECURITY_CVM_UPDATED",
    "SECURITY_CVM_UPDATE_FAILED",
...
async def redact_user_audit_trail(conn: asyncpg.Connection, *, email: str, replacement: str) -> None:
    ...
    from umbra_console.audit_anchor import publish_audit_chain_redaction_reanchor
