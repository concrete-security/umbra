...
from concrete_console.metrics import observe_redacted_value_in_log
...
def _emit_redaction_alarm(*, source: str, key: str) -> None:
    ...
    logging.getLogger("concrete_console.redaction").error(json.dumps(payload, sort_keys=True))
