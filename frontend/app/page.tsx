                    ...
                    <div className="flex flex-wrap gap-2">
                      {examplePrompts.map((example, idx) => (
                        <button
                          ...
                          disabled={isTransitioning}
                          className="inline-flex items-center gap-1.5 rounded-full border border-[#d7d5eb] bg-white/80 px-3 py-1.5 text-xs text-[#1F1E28]/80 transition hover:bg-white hover:text-[#08070B] disabled:border-[#d7d5eb]/60 disabled:text-[#1F1E28]/40"
                        >
